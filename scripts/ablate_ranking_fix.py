"""Re-evaluate kit #1 after within-user BPR and user-grouped batches."""
...
OUT = ROOT / "run" / "ablate_ranking_fix"
FILES = (
    "pipeline.py",
    "fm.py",
    "train.py",
...
VARIANTS = {
    "bpr_within_user": {"loss": "bpr"},
    "listwise_userbatch": {"loss": "listwise"},
    "hour": {"use_hour": True},
...
def run_trial(dest: Path) -> dict:
    ...
    if proc.returncode != 0:
        tail = log.read_text(encoding="utf-8")[-1500:]
