"""Official FM + BPR + DIN at seq_len 20 / 50 / 100."""
...
VARIANTS = {
    "bpr_din20": {"loss": "bpr", "seq_len": 20, "seq_mode": "din"},
    "bpr_din50": {"loss": "bpr", "seq_len": 50, "seq_mode": "din"},
    "bpr_din100": {"loss": "bpr", "seq_len": 100, "seq_mode": "din"},
}
...
def run_trial(dest: Path) -> dict:
    ...
    if proc.returncode != 0:
        tail = log.read_text(encoding="utf-8")[-1200:]
