...
| [`pure-v6/progress.log`](pure-v6/progress.log) | Readable Pure trace |
...
| [`pure-v5/`](pure-v5/) | Repeat freeze-eval search (DeepFM + BPR) |
...
Contest search. 3-seed DeepFM + seq-100 pool + l2. 50/50 billed iterations, 1.87 h, 0 runtime interventions.

## Repeat Pure search (`pure-v5/`)

A second freeze-eval search. DeepFM + BPR bag, valid 0.60440 / hidden 0.59766 — also above the official FM.
